...
class CourseRunSearchSerializer(HaystackSerializer):
    ...
    first_enrollable_paid_seat_price_currency = serializers.SerializerMethodField()
    ...
    def get_first_enrollable_paid_seat_price_currency(self, result):
        return result.object.first_enrollable_paid_seat_price_currency
    ...
    class Meta:
        ...
        fields = search_indexes.BASE_SEARCH_INDEX_FIELDS + (
            ...
            'first_enrollable_paid_seat_price_currency',
            'full_description',
            'go_live_date',
