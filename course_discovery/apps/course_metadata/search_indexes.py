...
class CourseRunIndex(BaseCourseIndex, indexes.Indexable):
    ...
    first_enrollable_paid_seat_price = indexes.IntegerField(null=True)
    first_enrollable_paid_seat_price_currency = indexes.CharField(null=True)
    ...
    def prepare_first_enrollable_paid_seat_price_currency(self, obj):
        return obj.first_enrollable_paid_seat_price_currency
